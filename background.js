(function() {
  ...
  chrome.identity.getProfileUserInfo(function(userInfo) {
    ...
    signUp(userInfo, function(res){
      ...
      setDisplayBadge(currentUser.badge_number)
      loadCable(currentUser);
    })
  ...
  var loadCable = function(user){
    var cable = ActionCable.createConsumer();

    cable.subscriptions.create({channel: 'ArticlesChannel', room: user.room_name}, {
      received: function(data){
        setDisplayBadge(data.number)
      }
    })
  }
